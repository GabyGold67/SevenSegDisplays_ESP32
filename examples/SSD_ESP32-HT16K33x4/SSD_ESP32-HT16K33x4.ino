 ...
 *       Last update:   21/06/2025 17:50 GMT+0200 DST  
 ******************************************************************************
...
void mainCtrlTsk(void *pvParameters){
   ...
   bool myBlinkMask[5] {true, true, true, true, true}; 

   uint8_t theNewOrder [4] {4, 3, 1, 0};
   ...
   SevenSegDispHw* myLedDispHwPtr {new SevenSegHT16K33 (myDispIOPins, 4, 0x70)};
   ...
   for(;;){
      ...
      //Digits positions tests
      {
         testResult = myLedDisp.print("0123");
         vTaskDelay(testTime*3);
      }
      {
      ...
      {
         testResult = myLedDisp.print(" 1  ");
         vTaskDelay(testTime*2);
      }
      {
         testResult = myLedDisp.print("  2 ");
         vTaskDelay(testTime*2);
      }
      {
         testResult = myLedDisp.print("   3");
         vTaskDelay(testTime*2);
      }
   
      //Dots positions tests
      {
